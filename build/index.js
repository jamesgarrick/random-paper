...
var require_serverless = __commonJS((exports, module) => {
  ...
  var si = T((Le) => {
    ...
    a(zn, "assertSize");
    function Uo(r, e, t) {
      return zn(r), r <= 0 ? pe(r) : e !== undefined ? typeof t == "string" ? pe(r).fill(e, t) : pe(r).fill(e) : pe(r);
    }
    a(Uo, "alloc");
    ...
    h.prototype.readBigUInt64LE = be(a(function(e) {
      ...
      (t === undefined || n === undefined) && Ve(e, this.length - 8);
    ...
    function ti(r, e, t, n, i) {
      return e = +e, t = t >>> 0, i || ei(r, e, t, 4, 340282346638528860000000000000000000000, -340282346638528860000000000000000000000), Be.write(r, e, t, n, 23, 4), t + 4;
    }
    a(ti, "writeFloat");
    ...
    function ri(r, e, t, n, i) {
      return e = +e, t = t >>> 0, i || ei(r, e, t, 8, , -), Be.write(r, e, t, n, 52, 8), t + 8;
    }
    a(ri, "writeDouble");
    ...
    zt("ERR_OUT_OF_RANGE", function(r, e, t) {
      ...
      return Number.isInteger(t) && Math.abs(t) > 2 ** 32 ? i = Gn(String(t)) : typeof t == "bigint" && (i = String(t), (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (i = Gn(i)), i += "n"), n += ` It must be ${e}. Received ${i}`, n;
    }, RangeError);
    function Gn(r) {
    ...
    function Xo(r, e, t) {
      Re(e, "offset"), (r[e] === undefined || r[e + t] === undefined) && Ve(e, r.length - (t + 1));
    }
    a(Xo, "checkBounds");
  ...
  var ve = T((Fl, Yt) => {
    ...
    function li(r, e, t, n) {
      var i, s, o;
      if (yt(t), s = r._events, s === undefined ? (s = r._events = Object.create(null), r._eventsCount = 0) : (s.newListener !== undefined && (r.emit("newListener", e, t.listener ? t.listener : t), s = r._events), o = s[e]), o === undefined)
    ...
    B.prototype.removeListener = a(function(e, t) {
      var n, i, s, o, u;
      if (yt(t), i = this._events, i === undefined)
        return this;
    ...
    function hi(r, e, t) {
      ...
      if (n === undefined)
        return [];
      var i = n[e];
      return i === undefined ? [] : typeof i == "function" ? t ? [i.listener || i] : [i] : t ? ca(i) : di(i, i.length);
    }
    a(hi, "_listeners");
  ...
  var ji = T((yf, Wi) => {
    ...
    var Za = a(function(r) {
      ...
      r(20, Ni), r(21, cr), r(23, cr), r(26, cr), r(700, parseFloat), r(701, parseFloat), r(16, Qi), r(1082, xt), r(1114, xt), r(1184, xt), r(600, lr), r(651, ne), r(718, eu), r(1000, za), r(1001, Xa), r(1005, or), r(1007, or), r(1028, or), r(1016, Ya), r(1017, Za), r(1021, ar), r(1022, ar), r(1231, ar), r(1014, ne), r(1015, ne), r(1008, ne), r(1009, ne), r(1040, ne), r(1041, ne), r(1115, ur), r(1182, ur), r(1185, ur), r(1186, Oi), r(1187, Ja), r(17, qi), r(114, JSON.parse.bind(JSON)), r(3802, JSON.parse.bind(JSON)), r(199, Di), r(3807, Di), r(3907, ne), r(2951, ne), r(791, ne), r(1183, ne), r(1270, ne);
    }, "init");
    Wi.exports = { init: tu };
  });
  var $i = T((gf, Hi) => {
  ...
  var Yi = T((xf, Ki) => {
    ...
    var nu = $i(), L = a(function(r, e, t, n, i) {
      ...
      r(20, nu), r(21, iu), r(23, Gi), r(26, Gi), r(1700, au), r(700, su), r(701, ou), r(16, cu), r(1114, Vi.bind(null, false)), r(1184, Vi.bind(null, true)), r(1000, Je), r(1007, Je), r(1016, Je), r(1008, Je), r(1009, Je), r(25, uu);
    }, "init");
    Ki.exports = { init: lu };
  });
  var Ji = T((Af, Zi) => {
  ...
  function rt(r) {
    let e = 1779033703, t = 3144134277, n = 1013904242, i = 2773480762, s = 1359893119, o = 2600822924, u = 528734635, c = 1541459225, l = 0, f = 0, y = [
      ...
      for (let R = 16;R < 64; R++) {
        let j = g(A[R - 15], 7) ^ g(A[R - 15], 18) ^ A[R - 15] >>> 3, fe = g(A[R - 2], 17) ^ g(A[R - 2], 19) ^ A[R - 2] >>> 10;
        A[R] = A[R - 16] + j + A[R - 7] + fe | 0;
      }
      let I = e, w = t, Z = n, W = i, J = s, X = o, oe = u, ae = c;
      for (let R = 0;R < 64; R++) {
        let j = g(J, 6) ^ g(J, 11) ^ g(J, 25), fe = J & X ^ ~J & oe, me = ae + j + fe + y[R] + A[R] | 0, Ge = g(I, 2) ^ g(I, 13) ^ g(I, 22), he = I & w ^ I & Z ^ w & Z, Ie = Ge + he | 0;
  ...
  var ds = T((nh, ps) => {
    ...
    a(qe, "hmacSha256");
    function Wu(r, e, t) {
      for (var n = qe(r, d.concat([e, d.from([0, 0, 0, 1])])), i = n, s = 0;s < t - 1; s++)
        n = qe(r, n), i = hs(i, n);
      return i;
    }
    a(Wu, "Hi");
...
`);
    ...
    ye.exports.getPassword = function(r, e, t) {
      ...
      var o = a(function() {
        ...
        e.destroy(), Ir("WARNING: error on reading file: %s", c), t(undefined);
      }, "onErr");
  ...
  var Ms = T((Ph, ks) => {
    p();
    var pc = tt(), Fs = /^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/, kr = class kr2 {
      constructor(e, t) {
  ...
  var qs = T((Lh, Os) => {
    p();
    var { EventEmitter: dc } = ve(), Us = Ms(), Ds = st(), Ur = class Ur2 extends dc {
      constructor(e, t, n) {
  ...
  var hn = T((_) => {
    ...
    var Zr = class Zr2 extends Error {
      constructor(e, t, n) {
  ...
  var js = T((kt) => {
    ...
    var Oc = d.allocUnsafe(0), gn = class gn2 {
      constructor(e = 0) {
  ...
  var Gs = T((Mt) => {
    ...
    Mt.Parser = undefined;
    var k = hn(), qc = js(), bn = 1, Qc = 4, Hs = bn + Qc, $s = d.allocUnsafe(0), xn = class xn2 {
      constructor(e) {
  ...
  var Sn = T((Ee) => {
    ...
    Ee.DatabaseError = Ee.serialize = Ee.parse = undefined;
    var Nc = hn();
    Object.defineProperty(Ee, "DatabaseError", { enumerable: true, get: a(function() {
  ...
  var Cn = T((tp, Zs) => {
    p();
    var Ks = (ke(), O(gi)), Gc = ve().EventEmitter, { parse: Vc, serialize: Q } = Sn(), Ys = Q.flush(), zc = Q.sync(), Kc = Q.end(), An = class An2 extends Gc {
      constructor(e) {
  ...
  var eo = T((sp, Xs) => {
    p();
    var Yc = ve().EventEmitter, ip = (at(), O(ot)), Zc = st(), _n = ds(), Jc = Cs(), Xc = At(), el = Bt(), Js = qs(), tl = it(), rl = Cn(), In = class In2 extends Yc {
      constructor(e) {
  ...
  var io = T((up, no) => {
    ...
    }, "removeWhere"), Bn = class Bn2 {
      constructor(e, t, n) {
        this.client = e, this.idleListener = t, this.timeoutId = n;
      }
    };
    a(Bn, "IdleItem");
    var Tn = Bn, Rn = class Rn2 {
      constructor(e) {
        this.callback = e;
      }
    };
        ...
        this.options.connectionTimeoutMillis && (i = setTimeout(() => {
          ...
          if (i && clearTimeout(i), t.on("error", n), o)
            ...
            if (this.log("new client connected"), this.options.maxLifetimeSeconds !== 0) {
              let u = setTimeout(() => {
                this.log("ending client due to expired lifetime"), this._expired.add(t), this._idle.findIndex((l) => l.client === t) !== -1 && this._acquireClient(t, new je((l, f, y) => y()), n, false);
  ...
  var xi = a((r, e, t) => (e in r) ? pa(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t, "__defNormalProp");
  var ga = a((r, e) => {
    for (var t in e || (e = {}))
  ...
  var va = 1008000;
  var Si = new Uint8Array(new Uint16Array([258]).buffer)[0] === 2;
  ...
  function yr(r, {
    ...
    a(D, "templateFn"), D.query = (P, I, w) => new xe(Y, { query: P, params: I ?? [] }, w), D.unsafe = (P) => new Ue(P), D.transaction = async (P, I) => {
    ...
    async function Y(P, I, w) {
      let { fetchEndpoint: Z, fetchFunction: W } = se, J = Array.isArray(P) ? { queries: P.map((ee) => os(ee)) } : os(P), X = n ?? {}, oe = e ?? false, ae = t ?? false, R = i, j = s, fe = o;
      w !== undefined && (w.fetchOptions !== undefined && (X = { ...X, ...w.fetchOptions }), w.arrayMode !== undefined && (oe = w.arrayMode), w.fullResults !== undefined && (ae = w.fullResults), w.isolationLevel !== undefined && (R = w.isolationLevel), w.readOnly !== undefined && (j = w.readOnly), w.deferrable !== undefined && (fe = w.deferrable)), I !== undefined && !Array.isArray(I) && I.fetchOptions !== undefined && (X = { ...X, ...I.fetchOptions });
      let me = u;
      !Array.isArray(I) && I?.authToken !== undefined && (me = I.authToken);
      let Ge = typeof Z == "function" ? Z(g, A, { jwtAuth: me !== undefined }) : Z, he = { "Neon-Connection-String": r, "Neon-Raw-Text-Output": "true", "Neon-Array-Mode": "true" }, Ie = await Fu(me);
      Ie && (he.Authorization = `Bearer ${Ie}`), Array.isArray(P) && (R !== undefined && (he["Neon-Batch-Isolation-Level"] = R), j !== undefined && (he["Neon-Batch-Read-Only"] = String(j)), fe !== undefined && (he["Neon-Batch-Deferrable"] = String(fe))), c || se.disableWarningInBrowsers || Ke();
      let we;
      try {
      ...
      if (we.ok) {
        ...
        if (Array.isArray(P)) {
          ...
          return M.map(($, ge) => {
            ...
            return as($, { arrayMode: vo, fullResults: xo, types: qt.types });
          });
        } else {
  ...
  function as(r, {
    ...
    let i = new us.default(n), s = r.fields.map((c) => c.name), o = r.fields.map((c) => i.getTypeParser(c.dataTypeID)), u = e === true ? r.rows.map((c) => c.map((l, f) => l === null ? null : o[f](l))) : r.rows.map((c) => Object.fromEntries(c.map((l, f) => [s[f], l === null ? null : o[f](l)])));
  ...
  p();
  var wo = Ae(ct());
  var Un = class Un2 extends wo.Client {
    constructor(t) {
      super(t);
      this.config = t;
    }
    ...
    async _handleAuthSASLContinue(t) {
      ...
      let w = P, Z = await n.importKey("raw", w, { name: "HMAC", hash: { name: "SHA-256" } }, false, ["sign"]), W = new Uint8Array(await n.sign("HMAC", Z, A.encode("Client Key"))), J = await n.digest("SHA-256", W), X = "n=*,r=" + i.clientNonce, oe = "r=" + c + ",s=" + l + ",i=" + y, ae = "c=biws,r=" + c, R = X + "," + oe + "," + ae, j = await n.importKey("raw", J, { name: "HMAC", hash: { name: "SHA-256" } }, false, ["sign"]);
      var fe = new Uint8Array(await n.sign("HMAC", j, A.encode(R))), me = d.from(W.map((M, $) => W[$] ^ fe[$])), Ge = me.toString("base64");
      let he = await n.importKey("raw", w, { name: "HMAC", hash: { name: "SHA-256" } }, false, ["sign"]), Ie = await n.sign("HMAC", he, A.encode("Server Key")), we = await n.importKey("raw", Ie, { name: "HMAC", hash: { name: "SHA-256" } }, false, ["sign"]);
      var ee = d.from(await n.sign("HMAC", we, A.encode(R)));
  ...
  a(vl, "promisify");
  var Dn = class Dn2 extends go.Pool {
    constructor() {
      super(...arguments);
      E(this, "Client", $e);
    ...
    query(t, n, i) {
      ...
      try {
        ...
        yr(l, { fullResults: true, arrayMode: t.rowMode === "array" }).query(f, y, { types: t.types ?? this.options?.types }).then((A) => i(undefined, A)).catch((A) => i(A));
      } catch (o) {
        i(o);
      }
      return s.result;
...
// index.html
var random_paper_default = __jsonParse("{\"index\":\"./index.html\",\"files\":[{\"input\":\"index.html\",\"path\":\"./index-y1e0g89h.js\",\"loader\":\"js\",\"isEntry\":true,\"headers\":{\"etag\":\"NzsptgNfsik\",\"content-type\":\"text/javascript;charset=utf-8\"}},{\"input\":\"index.html\",\"path\":\"./index.html\",\"loader\":\"html\",\"isEntry\":true,\"headers\":{\"etag\":\"mANib4eLXyE\",\"content-type\":\"text/html;charset=utf-8\"}},{\"input\":\"index.html\",\"path\":\"./index-5xa3hc9g.css\",\"loader\":\"css\",\"isEntry\":true,\"headers\":{\"etag\":\"2WkhqNzMMpI\",\"content-type\":\"text/css;charset=utf-8\"}}]}");
